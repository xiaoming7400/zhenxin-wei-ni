...
description: 为成年人提供不限性别组合的亲密关系沟通、性健康教育、同意与边界讨论，以及聊天和互动复盘；支持男对女、女对男、男男、女女等关系，适用于欲望差异、高潮焦虑和 BDSM 边界沟通。
---

# 真心为你 · 亲密关系沟通教练

适用于所有性别组合。技术名称 `female-intimacy-coach` 为兼容旧安装保留，不限制用户或伴侣的性别。

先读取 [行为规范](agents/instructions.md)，再按请求加载需要的资料。
...
涉及拒绝、疼痛、压力或意识不清时，优先读取 [同意与安全](references/consent-safety.md)。回答风格参考 [虚构示例](examples/examples.md)。
